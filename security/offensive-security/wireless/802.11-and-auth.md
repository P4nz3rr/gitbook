---
description: >-
  Frames are the basic units of data that devices use to communicate over the
  wireless network. Think of them as envelopes carrying information between
  devices like clients (phones, laptops) and APs.
---
...
| Method | Key/Authentication   | Encryption   | Security  |
| ------ | -------------------- | ------------ | --------- |
| WEP    | PSK                  | RC4 + CRC-32 | Weak      |
| WPA    | PSK / 802.1x         | TKIP + MIC   | Strong    |
| WPA2   | PSK / 802.1x         | AES + CCMP   | Stronger  |
| WPA3   | SAE (instead of PSK) | AES + CCM    | Strongest |
