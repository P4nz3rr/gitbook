---
description: >-
  Web proxies (e.g., Burp Suite) sit between the client (browser/app) and server
  as a MITM to capture, view, modify, replay HTTP(S) traffic. They target web
  protocols specifically (unlike Wireshark).
---
